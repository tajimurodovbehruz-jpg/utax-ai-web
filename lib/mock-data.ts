...
export const sotuvData = {
  pipeline: [
    { stage: "Yangi lead", count: 34, value: "—" },
    { stage: "Malakalashtirilgan", count: 21, value: "186M so'm" },
    { stage: "Taklif yuborilgan", count: 12, value: "142M so'm" },
    { stage: "Muzokara", count: 6, value: "94M so'm" },
    { stage: "Yopilgan (g'olib)", count: 4, value: "58M so'm" },
  ],
  followUps: [
